...
<Canvas of={MasFooterStories.Default}>
</Canvas>
...
<Canvas of={MasFooterStories.Footer_Desktop }>
</Canvas>
- **Mobile**: Designed for smaller screens and mobile devices.
<Canvas of={MasFooterStories.Footer_Mobile}>
</Canvas>
...
### `default`:
### 1- desktop:
<Canvas of={MasFooterStories.Footer_Default_desktop }>
</Canvas>
### 2- mobile:
<Canvas of={MasFooterStories.Footer_Default_Mobile}>
</Canvas>
### `swapComponent`:
### 1- desktop:
<Canvas of={MasFooterStories.Footer_SwapComponent_desktop}>
</Canvas>
### 2- mobile:
<Canvas of={MasFooterStories.Footer_SwapComponent_mobile}>
</Canvas>
...
<Canvas of={MasFooterStories.Footer_Default_desktop_Two_Blocks}>
</Canvas>
...
<Canvas of={MasFooterStories.Footer_Default_desktop_Without_socialMedia}>
</Canvas>
...
<Canvas of={MasFooterStories.Footer_Default_desktop_Without_Logotype}>
</Canvas>
...
<Canvas of={MasFooterStories.Footer_Default_desktop_Without_MiddleFooter}>
</Canvas>
## Guidelines
