...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Buttons serve as navigational elements and can be used independently or inline with text. They offer a lightweight option for navigation.',
      },
    },
  },
  render: ({ ...args }) => ({
...
type Story = StoryObj<MasPopOver>;
/** Basic : A button with default settings */

export const Default: StoryObj<MasPopOver> = {};
Default.args = {
  text: 'Hover me!',
  title: 'Popover Title',
